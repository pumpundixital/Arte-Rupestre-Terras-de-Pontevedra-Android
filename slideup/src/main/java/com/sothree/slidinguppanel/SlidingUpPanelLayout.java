...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private void setScrollableView(View scrollableView) {
    ...
    private void dispatchOnPanelStateChanged(View panel, PanelState previousState, PanelState newState) {
        synchronized (mPanelSlideListeners) {
            for (PanelSlideListener l : mPanelSlideListeners) {
     ...
     */
    private boolean smoothSlideTo(float slideOffset, int velocity) {

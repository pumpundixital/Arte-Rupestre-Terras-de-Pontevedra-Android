...
public class LeBubbleView extends RelativeLayout implements Runnable {
    ...
    void onInitialize(AttributeSet attrs, int defStyleAttr, TypedArray a) {

    }

    private void setCurThemeStyle(int textColor) {
    ...
    void initChildView(float radius, int backgroundColor, int textColor, float textSize, String content) {
    ...
    void onPostCallBack(int conRlw, int conRlh) {

...
import co.mobiwise.materialintro.bubble.LeBubbleTextView;
...
public class MaterialIntroView extends RelativeLayout {
     ...
     * Info Dialog Text
     */
    private LeBubbleTextView textViewInfo;
    ...
    private void init(Context context) {
        ...
        textViewInfo = layoutInfo.findViewById(R.id.textview_info);
    ...
    private void setConfiguration(MaterialIntroConfiguration configuration) {
